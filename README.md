...
Two-pass assembler and stack-based emulator for the SIMPLEX educational ISA. Built in C .

It encodes/decodes 32-bit instructions, handles labels, branches, pseudo-instructions, and runtime safety checks.
...
- factorial.asm       - Factorial of Numbers

- fibonacci.asm       - Iterative Fibonacci Algorithm
...
- test02.asm          - Error-detection test (diagnoses duplicate/missing labels, invalid mnemonics)
